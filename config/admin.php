...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | This value is the name of ava, This setting is displayed on the
    | login page.
    |
    */
    'name' => 'AVA',
    ...
    */
    'auth' => [
        ...
        'providers' => [
            'admin' => [
                'driver' => 'eloquent',
                'model'  => LApolinario\Ava\Auth\Database\Administrator::class,
            ],
        ],
    ...
    */
    'database' => [
        ...
        'permissions_model' => LApolinario\Ava\Auth\Database\Permission::class,

        // Menu table and model.
        'menu_table' => 'admin_menu',
        'menu_model' => LApolinario\Ava\Auth\Database\Menu::class,
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'grid_action_class' => \LApolinario\Ava\Grid\Displayers\DropdownActions::class,
