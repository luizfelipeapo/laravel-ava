...
namespace LApolinario\Ava;

use Closure;
use LApolinario\Ava\Auth\Database\Menu;
use LApolinario\Ava\Controllers\AuthController;
use LApolinario\Ava\Layout\Content;
use LApolinario\Ava\Traits\HasAssets;
use LApolinario\Ava\Widgets\Navbar;
...
class Admin
{
     ...
     * @param Closure $callable
     *
     * @return \LApolinario\Ava\Layout\Content
     *
     * @deprecated since v1.6.1
     */
     ...
     * Get navbar object.
     *
     * @return \LApolinario\Ava\Widgets\Navbar
     */
    ...
    public function routes()
    {
        ...
        app('router')->group($attributes, function ($router) {
            ...
            $router->namespace('\LApolinario\Ava\Controllers')->group(function ($router) {
