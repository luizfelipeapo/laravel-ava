...
namespace LApolinario\Ava\Form;

use LApolinario\Ava\Admin;
use LApolinario\Ava\Form;
use LApolinario\Ava\Widgets\Form as WidgetForm;
...
class NestedForm
{
    ...
    /**
     * @var \LApolinario\Ava\Form|\LApolinario\Ava\Widgets\Form
     */
    protected $form;
    ...
    protected function prepareRecord($record)
    {
        ...
        foreach ($this->fields as $field) {
            ...
            if (($field instanceof \LApolinario\Ava\Form\Field\Hidden) || $value != $field->original()) {
                if (is_array($columns)) {
