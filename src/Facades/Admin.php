...
namespace LApolinario\Ava\Facades;
 ...
 * Class Admin.
 *
 * @method static \LApolinario\Ava\Grid grid($model, \Closure $callable)
 * @method static \LApolinario\Ava\Form form($model, \Closure $callable)
 * @method static \LApolinario\Ava\Show show($model, $callable = null)
 * @method static \LApolinario\Ava\Tree tree($model, \Closure $callable = null)
 * @method static \LApolinario\Ava\Layout\Content content(\Closure $callable = null)
 ...
 *
 * @see \LApolinario\Ava\Admin
 */
class Admin extends Facade
{
    protected static function getFacadeAccessor()
    {
        return \LApolinario\Ava\Admin::class;
    }
}
